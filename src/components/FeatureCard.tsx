...
export default function FeatureCard({
  ...
  return (
    <div className="group relative">
      ...
      {/* Border glow effect */}
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-lime-500/20 via-lime-500/0 to-lime-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm"></div>
